...
name = 'LP_wiki_talk'
file = '/Users/yanwenzhang/Desktop/0_research_copy/12_network/4_data/'+ name + '/wiki-talk-washed.txt'
...
if __name__ == "__main__":
    ...
    for t in t_gap:
        ...
        data.to_csv('/Users/yanwenzhang/Desktop/0_research_copy/12_network/4_data/'+ str(name) +'/tGap_Role2Vec/accuarcy_netmf_tGap='+str(int(t))+'.csv')
        t_num = t_num + 1